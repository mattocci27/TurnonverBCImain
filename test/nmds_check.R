...
tr <- data.frame(sp=trait1$SP,
         WSG = trait1$WSG,
         moist = trait1$Moist,
         slope = trait1$slope_size_100,
         convex = trait1$convex_size_100)
...
north <- grep("_4$|_5$",rownames(D100m[[1]]))
south <- grep("_1$|_2$",rownames(D100m[[1]]))

D100m.north <- rbind(D100m[[1]][north,],
    D100m[[2]][north,],
    D100m[[3]][north,],
    D100m[[4]][north,],
    D100m[[5]][north,],
...
D100m.south <- rbind(D100m[[1]][south,],
    D100m[[2]][south,],
    D100m[[3]][south,],
    D100m[[4]][south,],
    D100m[[5]][south,],
...
D100m.north.r<-D100m.north
D100m.north.r[,"PIPECO"] <- rep(D100m[[1]][north,"PIPECO"],7)
D100m.north.r[,"POULAR"] <- rep(D100m[[1]][north,"POULAR"],7)


D100m.south.r<-D100m.south
D100m.south.r[,"PIPECO"] <- rep(D100m[[1]][south,"PIPECO"],7)
D100m.south.r[,"POULAR"] <- rep(D100m[[1]][south,"POULAR"],7)



com.nmds.south <- metaMDS(D100m.south,engine="monoMDS",k=3, trymax=50)
com.nmds.north <- metaMDS(D100m.north,engine="monoMDS",k=3, trymax=50)
com.nmds.all <- metaMDS(D100m.all,engine="monoMDS",k=3, trymax=50)
...
par(mfrow=c(3,1))
plot.nmds(D100m.all,range="north",axis="1-2",n.census=7, engine="monoMDS",k=3,trymax=50)
plot.nmds(D100m.all,range="south",axis="1-2",n.census=7, engine="monoMDS",k=3,trymax=50)
plot.nmds(D100m.all,range="all",axis="1-2",n.census=7, engine="monoMDS",k=3,trymax=50)
par(mfrow=c(3,1))
dev.off()
